 ...
 * @@Modify Date: 2018-06-12 16:15:35
 * @@Function:
 */

namespace Magiccart\Orderforward\Controller\Adminhtml;
...
abstract class Action extends \Magento\Backend\App\Action
{
    ...
    protected $_orderforwardCollectionFactory;
    /**
     * Registry object.
     *
    ...
    protected function _isAllowed()
    {
        ...
        return $this->_authorization->isAllowed("Magiccart_Orderforward::orderforward_$action");
    }
}
